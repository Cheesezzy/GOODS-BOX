    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <div className='flex flex-col justify-center items-center gap-5'>
                ...
                <div className='flex items-center flex-1 p-[20px] w-[80%] bg-[#F4F4F4]'>
                    <img src={location} alt="location" className='pr-4' />
                    <input type="text" placeholder='Enter pick up location' className='w-full bg-[#F4F4F4] placeholder-[#A9A9A9]' />
                </div>

                <div className='flex items-center flex-1 p-[20px] w-[80%] bg-[#F4F4F4]'>
                    <img src={bxLocation} alt="location" className='pr-4' />
                    <input type="text" placeholder='Delivery destination' className='w-full bg-[#F4F4F4] placeholder-[#A9A9A9]' />
                </div>



                <div className='flex gap-5 mt-5'>
                    <button className='flex items-center justify-center bg-[#3632DF] text-[#fff] p-4 px-8 rounded-md'>Sign up</button>
                    <button>Request Pick Up</button>
                </div>


                <p>Send anywhere with ease with the click of a button!</p>
            </div>
